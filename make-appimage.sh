...
# Deploy dependencies
quick-sharun /usr/lib/octave /usr/lib/octave/*/exec/*/octave-gui /usr/lib/octave/*/lib*.so* /usr/share/octave /usr/bin/octave /usr/bin/octave-cli /usr/lib/qt6/plugins/sqldrivers
